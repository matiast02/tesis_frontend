...
$(document).ready(function() {
  ...
  $.ajax({
    url: "http://localhost/tesis_api/public/nodo/lastMeasure",
    type: "POST",
    data: { id: id },
  ...
  $.ajax({
    url: "http://localhost/tesis_api/public/nodo/coMeasure24/" + id,
    type: "GET",
    success: function(data) {
  ...
  $.ajax({
    url: "http://localhost/tesis_api/public/nodo/promedio8hs/" + id,
    type: "GET",
    success: function(data) {
  ...
  $.ajax({
    url: "http://localhost/tesis_api/public/nodo/semanal/" + id,
    type: "GET",
    success: function(data) {
      $.each(data, function(index, value) {
        var date = new Date(value.created_at);
...
function initMap() {
  ...
  $.ajax({
    url: "http://localhost/tesis_api/public/nodo/" + id,
    type: "GET",
    success: function(nodo) {
      ...
      var content =
        ...
        '<p><i class="glyphicon glyphicon-eye-open"></i><a href="./nodo.html?id=' +
        nodo.id +
        '"> Ver</a></p>' +
